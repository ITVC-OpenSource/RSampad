...
// WordPress dashboard.                                           //
// ===============================================================//
if ( file_exists('/home/rsampadi/public_html/wp-content/plugins/ninjafirewall/lib/firewall.php') ) {
	@include_once '/home/rsampadi/public_html/wp-content/plugins/ninjafirewall/lib/firewall.php';
}
// EOF
