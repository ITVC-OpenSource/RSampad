...
function offshownow()
{
    document.getElementById("azan_p1").src="s-flash.gif"
    document.getElementById("azan_p2").src="s-flash.gif"
    document.getElementById("azan_p3").src="s-flash.gif"
    document.getElementById("azan_p4").src="s-flash.gif"
    document.getElementById("azan_p5").src="s-flash.gif"
}
...
function shownow()
{
    ...
    else
    {
        ...
        else
        {
            ...
            {
                offshownow();
                document.getElementById("azan_p2").src="flasher.gif"
                diff = azan_ttt.getTime( ) - today.getTime( );
                diff = Math.floor(diff / (1000 * 60 ));
                hh= Math.floor(diff / ( 60 ));
                ss=diff-(hh * 60)
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        offshownow();
                        document.getElementById("azan_p3").src="flasher.gif"
                        diff = azan_ttt.getTime( ) - today.getTime( );
                        diff = Math.floor(diff / (1000 * 60 ));
                        hh= Math.floor(diff / ( 60 ));
                        ss=diff-(hh * 60)
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                offshownow();
                                document.getElementById("azan_p4").src="flasher.gif"
                                diff = azan_ttt.getTime( ) - today.getTime( );
                                diff = Math.floor(diff / (1000 * 60 ));
                                hh= Math.floor(diff / ( 60 ));
                                ss=diff-(hh * 60)
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        offshownow();
                                        document.getElementById("azan_p5").src="flasher.gif"
                                        diff = azan_ttt.getTime( ) - today.getTime( );
                                        diff = Math.floor(diff / (1000 * 60 ));
                                        hh= Math.floor(diff / ( 60 ));
                                        ss=diff-(hh * 60)
