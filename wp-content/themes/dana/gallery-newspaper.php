...
<!--=================== news  =================================-->
		<div class="news <?php echo $cat_content_class; ?>">
			<div class="header-news">
				<h2><?php echo $themeoptions['newspaper-panel-title-slider'] ?></h2>
			</div>
			<?php
			$newspaper_args = array(
					'post_type' => 'newspaper',
					'posts_per_page' => $themeoptions['opt-page-newspaper-numbe']
				);
				query_posts($newspaper_args);
			require(get_template_directory() . '/inc/template/archive/content.php'); ?>
