function appendRow(theAttch) {
    ...
    var emptyRowTemplate = '<div id="row-miu-'+ data.id +'" style=\'margin-bottom: 20px;\'><img width="60" height="60" src="' + data.thumbnail + '" class="attachment-post-thumbnail" alt="'+data.filename+'" style=\'vertical-align: top;\' /><h4 style=\'text-align:center; display: inline-block;width: 180px;margin-left: 10px;\'>' + data.title + '</h4><a class="miu_remove_image_button" id="miu_row-'+ data.id +'">حذف</a><input type="hidden" name="miu_images[]" value="'+ encodeURIComponent(JSON.stringify(data)) +'" /></div>';
