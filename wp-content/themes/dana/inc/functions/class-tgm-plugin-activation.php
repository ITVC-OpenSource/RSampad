...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		...
		public function init() {
			...
			// Load class strings.
			$this->strings = array(
				'page_title'                      => __( 'نصب افزونه های مورد نیاز', 'tgmpa' ),
				'menu_title'                      => __( 'افزونه های پوسته', 'tgmpa' ),
				'installing'                      => __( 'Installing Plugin: %s', 'tgmpa' ),
				'oops'                            => __( 'Something went wrong with the plugin API.', 'tgmpa' ),
				'notice_can_install_required'     => _n_noop(
					'کابر گرامی جهت فعال شدن تنظیمات پوسته نصب این افزونه ضروری میباشد: %1$s.',
					'کاربر گرامی فعال بودن افزونه های مورد نظر جهت عملکرد صحیح پوسته ضروری میباشد. : %1$s.',
					'tgmpa'
				),
				'notice_can_install_recommended'  => _n_noop(
					'افزونه هایی که توصیه می کنیم نصب کنید: %1$s.',
					'افزونه هایی که توصیه می کنیم نصب کنیدs: %1$s.',
					'tgmpa'
				),
				...
				'return'                          => __( 'بازگشت برای نصب افزونه های مورد نیاز', 'tgmpa' ),
				'dashboard'                       => __( 'Return to the dashboard', 'tgmpa' ),
				'plugin_activated'                => __( 'افزونه با موفقیت فعال گردید.', 'tgmpa' ),
				'activated_successfully'          => __( 'The following plugin was activated successfully:', 'tgmpa' ),
				'plugin_already_active'           => __( 'No action taken. Plugin %1$s was already active.', 'tgmpa' ),
				'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', 'tgmpa' ),
				'complete'                        => __( 'همه افزونه های نصب شده با موفقیت فعال شدند. %s', 'tgmpa' ),
