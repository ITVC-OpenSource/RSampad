...
switch ($timingmode) {
    case 2:$daycount = date("z", $now_t);
        $jsat = ($daycount > 78 && $daycount < 265) ? 1 : 0;
        break;
    case 1:$jsat = 1;
        break;
    case 0:default:$jsat = 0;
    break;
}
?>
<div class="main-header-left col-lg-3 col-md-12">
	<aside class="widget oghat-shariee-widget">
		<div class="section_title title--decor5">
			اوقات شرعی
		<select id="cities" class="hu pull-left" size="1" onchange="coord();main();">
					...
					<option value="تهران" selected="selected">تهران</option>
		...
		<div class="oghat_wrap">
			<div class="oghat_item">
				<img src="<?php bloginfo('template_url'); ?>/assets/img/sun.png">
				<strong>اذان صبح</strong>
				<span id="azan_t1"></span>
			</div><!-- ./ oghat_item -->

			<div class="oghat_item">
				<img src="<?php bloginfo('template_url'); ?>/assets/img/sun1.png">
			...
			<div class="oghat_item">
				<img src="<?php bloginfo('template_url'); ?>/assets/img/moon.png">
...
$cities = $azan_opt['azan_custom_cities'];
$names = '';
$lgs = '';
$lats = '';
if(!empty($cities)){
...
function init() {
	lgs = [0, 49.70, 48.30, 45.07, 51.64, 48.68, 46.42, 57.33, 56.29, 50.84, 59.21, 46.28, 51.41, 48.34, 49.59, 60.86, 48.50, 53.06, 53.39, 47.00, 50.86, 52.52, 50.00, 50.88, 57.06, 47.09, 54.44, 59.58, 48.52, 51.59, 54.35'.$lgs.'];
	lats = [0, 34.09, 38.25, 37.55, 32.68, 31.32, 33.64, 37.47, 27.19, 28.97, 32.86, 38.08, 35.70, 33.46, 37.28, 29.50, 36.68, 36.57, 35.58, 35.31, 32.33, 29.62, 36.28, 34.64, 30.29, 34.34, 36.84, 36.31, 34.80, 30.67, 31.89'.$lats.'];
}
function coord() {
...
<?php
echo '<script type="text/javascript">var CurrentDate= "' . $now_d . '";
 var JAT= '.$jsat . ';
  function pz()
   {
   }
   init();
   document.getElementById("cities").selectedIndex=' . $defaultcity . ';
   coord();main();</script>';
?>
