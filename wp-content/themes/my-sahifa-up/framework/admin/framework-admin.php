...
if( is_admin() ){
	...
	*/
		...
		function tie_rate_pointer_print_scripts() {
			...
			$pointer_content .= "<p><a href=\'https://uptheme.ir/' target=\'_blank\'>".__( "If you like the theme, please don\'t forget to rate it :)", "tie")."</a></p>";
		?>
...
$default_data = Array(
	"tie_options"	=> Array(
		...
		'footer_two' 				=> 		'Powered by <a href="https://uptheme.ir/">WordPress</a> | Designed by <a href="https://uptheme.ir/">uptheme</a>',
		...
		'typography_general' => array( 'font' => 'Droid Sans:regular|700' ),
	)
);
