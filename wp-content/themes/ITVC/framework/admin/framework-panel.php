...
function tie_add_admin() {
	...
	function tie_get_support(){
		echo "<script type='text/javascript'>window.location='http://uptheme.ir/%d8%ac%d8%af%db%8c%d8%af%d8%aa%d8%b1%db%8c%d9%86-%d9%88%d8%b1%da%98%d9%86-%d9%82%d8%a7%d9%84%d8%a8-%d9%88%d8%b1%d8%af%d9%be%d8%b1%d8%b3-%d8%ad%d8%b1%d9%81%d9%87-%d8%a7%db%8c-%d8%b5%d8%ad%db%8c%d9%81/';</script>";
	}
...
<div class="mo-panel">
	<div class="mo-panel-tabs">
		...
		<ul>
			...
			<li class="tie-tabs tie-more tie-not-tab"><a target="_blank" href="http://uptheme.ir"><span class="dashicons-before dashicons-art tie-icon-menu"></span><?php _e( 'More Themes', 'tie' ) ?></a></li>
		</ul>
		<div class="clear"></div>
	</div> <!-- .mo-panel-tabs -->
